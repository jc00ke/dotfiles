...
if [ "$latest_version" != "v$installed_version" ]; then
  ...
  wget "https://github.com/alacritty/alacritty/archive/refs/tags/v$alacritty_version.tar.gz"
  ...
  cp -f extra/completions/alacritty.fish "${fish_complete_path[1]}/alacritty.fish"
